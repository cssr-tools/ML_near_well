        ...
        try:
            ...
            summary_files: list[pathlib.Path] = (
                ...
                [
                    ...
                    # for i in range(8)
                    for i, j in zip([0, 1, 2, 4, 5, 6], list(range(6)))
                ]
                + [
                    (
                        savedir_2d
            ...
            colors: list[str] = (
                ...
                + list(plt.cm.Greens(np.linspace(0.3, 0.7, 3)))  # type: ignore
            )
            linestyles: list[str] = ["dashed"] * 3 + ["dotted"] * 6
