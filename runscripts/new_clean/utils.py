...
def plot_member(
    ...
    **kwargs,
    ...
    Args:
        ...
        nn_dirname (Optional[str | pathlib.Path], optional): The directory of the neural network model. Defaults to None.
        y_param (Literal["p_w", "WI", "WI_log"], optional): The parameter to plot on the y-axis. Defaults to "WI".
        x_param (Literal["time", "radius"], optional): The parameter to plot on the x-axis. Defaults to "radius".
        comparison_param (Literal["time", "layer"], optional): The parameter to compare on the plot. Defaults to "layer".
        fixed_param_index (int, optional): The index of the fixed parameter. Defaults to 0.
    ...
    for num_comp, color in zip(
        ...
        plt.cm.Blues(np.linspace(1, 0.5, y_values_data_member.shape[0])),
    ):
