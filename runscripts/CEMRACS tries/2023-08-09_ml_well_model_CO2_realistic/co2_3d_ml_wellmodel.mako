...
${pressure*10e-5} 40  1    #Pressure [Pa] on the top, uniform temperature [°], and initial phase in the reservoir (0 wetting, 1 non-wetting)
...
10 1e-1 1e-1 1 ${rate*86400*1.86843}