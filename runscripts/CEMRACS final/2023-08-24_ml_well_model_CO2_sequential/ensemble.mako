...
${radius*2} 1 0                   #Well diameter [m], well transmiscibility (0 to use the computed one internally in Flow), and remove the smaller cells than the well diameter
...
SWI2 0. SNI2 0.0 KRW2 1 KRN2 1 PRE2 0 NKRW2 2 NKRN2 2 HNPE2 2 THRE2 1e-4 IGN1 0

"""Properties rock"""
"""Kxy [mD], Kz [mD], phi [-], thickness [m]"""
PERMXY2 ${permxy/9.869233e-16} PERMZ2 ${permz/9.869233e-16} PORO2 0.25 THIC2 1
...
% for days, rate in injection_schedule:
${days} 1e-1 1e-1 1 ${rate / 6} # Divided by 6, since the model runs on a cake of 1/6th size.
%endif