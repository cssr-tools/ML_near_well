...
${reservoir_size} 3      #Reservoir dimensions [m] (Lenght and height)
20 3 0        #Number of x- and z-cells [-] and exponential factor for the telescopic x-gridding (0 to use an equidistance partition)
...
3 0 0         #Number of layers [-] and hysteresis (1 to activate) and econ for the producer (for h2 models)
...
PERMXY5 ${perm1/9.869233e-16} PERMZ5 ${perm1/9.869233e-16} PORO5 0.25 THIC5 1
PERMXY5 ${perm2/9.869233e-16} PERMZ5 ${perm2/9.869233e-16} PORO5 0.25 THIC5 1
PERMXY5 ${perm3/9.869233e-16} PERMZ5 ${perm3/9.869233e-16} PORO5 0.25 THIC5 1
...
10 1e-1 1e-1 1 ${rate * 6 * 1.86843} # Multiplied by 6, since the model was trained on a cake of 1/6th size. Multiplied by 1.86843 to convert from m^3/day to kg/day