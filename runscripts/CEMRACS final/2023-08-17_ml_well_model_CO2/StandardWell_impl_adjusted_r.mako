...
;
    ...
    StandardWell<TypeTag>::wellIndexEval(const int perf, const double elapsed_time, const Value& pressure) const {
        ...
        // Scale the radius by 1.15 to account for the fact that during training the
        // radius at the edge of the radial cells was used.
        const auto re = Value(scaleFunction(connection.r0()*1.15, ${xmin[2]}, ${xmax[2]}));
