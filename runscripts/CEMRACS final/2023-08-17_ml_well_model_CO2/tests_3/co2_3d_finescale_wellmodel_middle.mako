...
10 3e-2 1e-1 1 ${rate * 6 * 1.86843} # Multiplied by 6, since the model was trained on a cake of 1/6th size. Multiplied by 1.86843 to convert from m^3/day to kg/day