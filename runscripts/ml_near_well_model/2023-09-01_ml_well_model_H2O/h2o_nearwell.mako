...
${2*radius} 1 0 #Well diameter [m], well transmiscibility (0 to use the computed one internally in Flow), and remove the smaller cells than the well diameter
...
10 1e-1 1e-1 0 ${rate*6*1.86843} # Multiplied by 6, since the model was trained on a cake of 1/6th size: multiplied by 1.86843 to convert from kg/day to m^3/day.