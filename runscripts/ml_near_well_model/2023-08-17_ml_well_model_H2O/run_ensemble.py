...
init_pressures: np.ndarray = np.random.uniform(90, 110, runspecs.NPOINTS)  # unit: bar
# init_pressures: np.ndarray = np.random.uniform(25, 35, runspecs.NPOINTS)  # unit: bar
