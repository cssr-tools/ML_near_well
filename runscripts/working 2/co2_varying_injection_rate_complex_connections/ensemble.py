...
def full_ensemble(
    ...
    data: dict[str, Any] = ensemble.run_ensemble(
        ...
        # Injection time is per injection rate, 5 different rates.
        num_report_steps=runspecs["constants"]["INJECTION_TIME"] * 5 * 10,
    )
...
class Dataset(BaseDataset):
    ...
    8. Analytical WI - per cell; unit [...] -> This is just for comparison and not used
        during training.
