...
INJECTION_RATE: float = 1.2e6  # unit: [m^3/d]
...
constants_integration_1: dict[str, Any] = runspecs_ensemble["constants"] | {
    ...
    "PERM_0": 7e-13 * units.M2_TO_MILIDARCY,  # unit: [mD]
    "PERM_1": 9e-13 * units.M2_TO_MILIDARCY,  # unit: [mD]
    "PERM_2": 2e-12 * units.M2_TO_MILIDARCY,  # unit: [mD]
    "PERM_3": 4e-12 * units.M2_TO_MILIDARCY,  # unit: [mD]
    "PERM_4": 8e-12 * units.M2_TO_MILIDARCY,  # unit: [mD]
...
runspecs_integration_3D_and_Peaceman_1: dict[str, Any] = {
    ...
    "nn_name": "trainspecs",
    "variables": {
        "GRID_SIZE": [6, 10, 20, 50, 6, 10, 20, 55],
        # "GRID_SIZE": [100, 6, 10, 20, 50, 6, 10, 20, 55],
        "ML_MODEL_PATH": [
            # "",
        ...
        "NUM_ZCELLS": [NUM_LAYERS] * 8,
        # "NUM_ZCELLS": [NUM_LAYERS] * 4,
        # "NUM_ZCELLS": [NUM_LAYERS * 5] + [NUM_LAYERS] * 8,
    },
...
runspecs_integration_2D_1: dict[str, Any] = runspecs_integration_3D_and_Peaceman_1 | {
    ...
    "variables": {
        "GRID_SIZE": [6, 10, 20, 55],
        "ML_MODEL_PATH": [
            str(dirname / ".." / "co2_2d_extended_2" / "nn" / "WI.model"),
            str(dirname / ".." / "co2_2d_extended_2" / "nn" / "WI.model"),
            str(dirname / ".." / "co2_2d_extended_2" / "nn" / "WI.model"),
            str(dirname / ".." / "co2_2d_extended_2" / "nn" / "WI.model"),
        ],
