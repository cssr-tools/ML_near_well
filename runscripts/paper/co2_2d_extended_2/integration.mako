...
${RESERVOIR_SIZE} ${int(HEIGHT)}    #Reservoir dimensions [m] (Length and height)
...
PERMXY1 ${PERM} PERMZ1 ${PERM} PORO1 ${POROSITY} THIC1 ${HEIGHT}
...
${INJECTION_TIME} ${REPORTSTEP_LENGTH} 1e-1 1 ${INJECTION_RATE}
