...
;
                  ...
                  ) const 
    {
        ...
        const auto injection_rate_per_second { 1200000 / 86000 };
        ...
        //for (int j = 0; j < 9; ++j) {
        //    std::cout << j << ": " << unscaleFunction(in.data_[j],xmin[j], xmax[j], feature_min, feature_max) << std::endl;
        //    std::cout << j << " scaled : " << in.data_[j] << std::endl;
        //}

        //std::cout << "WI: " << pow10(unscaleFunction(out.data_[0],${ymin}, ${ymax}, target_min, target_max)) << std::endl;
        std::cout << "WI log10: " << unscaleFunction(out.data_[0],${ymin}, ${ymax},target_min, target_max) << std::endl;
    ...
    // Value
    // StandardWell<TypeTag>::
    // log10_value(Value X) const
    // {
    //     Value result { log10(X) };
    //     return result;
    // }
